  ...
  <table border="0" align="center" width="95%">
    <tr>
      ...
      <td width="20%" valign="top">
        <h2>Calendar</h2>
        #showWeblogEntryCalendar($model.weblog "nil") #10
        <h2>Feeds</h2>
        #showAtomFeedsList($model.weblog) #11
        <h2>Search</h2>
        #showWeblogSearchForm($model.weblog false) #12
        <h2>Links</h2>
        #set($defaultFolder = $model.weblog.getBookmarkFolder("/")) #13
        #showBookmarkLinksList($defaultFolder)
        <h2>Navigation</h2>
        #showPageMenu($model.weblog) #14
        #showAuthorMenu(true) #15
        <h2>Referrers</h2>
        #set($refs = $model.weblog.getTodaysReferrers()) #16
...
Show the RSS and Atom auto-discovery links suitable for use within
